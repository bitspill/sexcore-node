...
describe('#defaultConfig', function() {
  var expectedExecPath = path.resolve(__dirname, '../../bin/sexcoind');
  ...
  it('will return expected configuration', function() {
    var config = JSON.stringify({
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            datadir: process.env.HOME + '/.sexcoin/data',
    ...
    info.path.should.equal(home + '/.sexcoin');
    ...
    bitcoind.spawn.datadir.should.equal(home + '/.sexcoin/data');
