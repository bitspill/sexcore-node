...
/**
 * Will return the path and sexcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'sexcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'sexcore-node.json'))
  };
}
