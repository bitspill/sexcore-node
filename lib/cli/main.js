...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `sexcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ sexcore-node add wallet-service');
      console.log('    $ sexcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ sexcore-node remove wallet-service');
      console.log('    $ sexcore-node remove insight-api');
      console.log();
    });
